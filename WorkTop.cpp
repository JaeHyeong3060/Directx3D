...
CWorkTop::CWorkTop(LPDIRECT3DDEVICE9 pGraphicDev)
	: CGameObject(pGraphicDev)
{

}

CWorkTop::CWorkTop(const CWorkTop& rhs)
	: CGameObject(rhs)
{

}

CWorkTop::~CWorkTop(void)
{

}

HRESULT CWorkTop::Ready_Object(void)
{
...
Engine::_int CWorkTop::Update_Object(const _float& fTimeDelta)
{
...
void CWorkTop::Render_Object(void)
{
	//if (false == m_bDraw)
	//	return;
...
HRESULT CWorkTop::Add_Component(void)
{
	CComponent*			pComponent = nullptr;

	// StaticMesh
	pComponent = m_pMeshCom = dynamic_cast<CStaticMesh*>(Clone_Proto(L"Proto_Mesh_WorkTop"));
...
void CWorkTop::SetUp_OnTerrain(void)
{
	_vec3	vPos;
	m_pTransformCom->Get_Info(INFO_POS, &vPos);
...
Engine::_bool CWorkTop::Collision_ToObject(const _tchar* pLayerTag, const _tchar* pObjTag)
{
...
HRESULT CWorkTop::SetUp_ConstantTable(LPD3DXEFFECT& pEffect)
{
...
CWorkTop* CWorkTop::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CWorkTop*	pInstance = new CWorkTop(pGraphicDev);
