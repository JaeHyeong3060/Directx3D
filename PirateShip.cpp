...
CPirateShip::CPirateShip(LPDIRECT3DDEVICE9 pGraphicDev)
	: CGameObject(pGraphicDev)
{

}

CPirateShip::CPirateShip(const CPirateShip& rhs)
	: CGameObject(rhs)
{

}

CPirateShip::~CPirateShip(void)
{

}

HRESULT CPirateShip::Ready_Object(void)
{
...
Engine::_int CPirateShip::Update_Object(const _float& fTimeDelta)
{
...
void CPirateShip::Render_Object(void)
{
	if (false == m_bDraw)
		return;
...
HRESULT CPirateShip::Add_Component(void)
{
	CComponent*			pComponent = nullptr;

	// StaticMesh
	pComponent = m_pMeshCom = dynamic_cast<CStaticMesh*>(Clone_Proto(L"Proto_Mesh_PirateShip"));
...
void CPirateShip::SetUp_OnTerrain(void)
{
	_vec3	vPos;
	m_pTransformCom->Get_Info(INFO_POS, &vPos);
...
Engine::_bool CPirateShip::Collision_ToObject(const _tchar* pLayerTag, const _tchar* pObjTag)
{
...
HRESULT CPirateShip::SetUp_ConstantTable(LPD3DXEFFECT& pEffect)
{
...
CPirateShip* CPirateShip::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CPirateShip*	pInstance = new CPirateShip(pGraphicDev);
