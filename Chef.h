...
END
class CChef : public CGameObject
{
private:
	explicit CChef(LPDIRECT3DDEVICE9 pGraphicDev);
	explicit CChef(const CChef& rhs);
	virtual ~CChef(void);
...
public:
	static CChef*		Create(LPDIRECT3DDEVICE9 pGraphicDev);
